...
# NOTE
# Skip for Next Run (instead run line 15)
DT_ens <- DT_T
...
# ggplot(DT_ens, aes(date_time, value)) +
#   geom_line() +
#   theme_ts
...
simple_rpart <- RpartTrend(DT_ens, n_date[1:21], K = 2)
...
# perform rpart without bagging and compare it with bagged raprt
simple_ctree <- CtreeTrend(DT_ens, n_date[1:21], K = 2)
